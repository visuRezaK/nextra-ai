...
- اگر کاربر صریحاً خواست با انسان صحبت کند (نه ربات)، با ابزار requestOperator درخواستش را ثبت کن، بعد نام و راه تماسش را بگیر و با captureLead ثبت کن تا همکار انسانی پیگیری کند.
